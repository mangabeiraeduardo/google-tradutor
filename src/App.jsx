    ...
    <div className='min-h-screen bg-background flex flex-col'>
      ...
      <header className='bg-white shadow-sm'>
        <div className='max-w-5xl mx-auto px-4 py-3 flex items-center'>
          <h1 className='text-headerColor text-2xl font-bold'>Tradutor DevClub</h1>
        </div>
      </header>
      ...
      <main className='flex-grow flex items-start justify-center px-4 py-8'>
        <div className='w-full max-w-5xl bg-white rounded-lg shadow-md overflow-hidden'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2'>
            ...
            <div className='p-4 relative bg-secondaryBackground border-1 border-gray-200'>
      ...
      <footer className='bg-white border-t border-gray-200 mt-auto'>
        <div className='max-w-5xl max-auto px-4 py-3 text-sm text-headerColor'>
